...
import { isClient as isClient2, isIOS } from "@vueuse/core";
...
var getStyle = (element, styleName) => {
  var _a;
  if (!isClient4 || !element || !styleName)
    return "";
...
var globalNodes = [];
var target = !isClient6 ? void 0 : document.body;
...
var rAF = (fn2) => isClient7 ? window.requestAnimationFrame(fn2) : setTimeout(fn2, 16);
var cAF = (handle) => isClient7 ? window.cancelAnimationFrame(handle) : clearTimeout(handle);
...
import { isClient as isClient8, isIOS as isIOS2 } from "@vueuse/core";
...
import { isClient as isClient9 } from "@vueuse/core";
var useLockscreen = (trigger, options = {}) => {
  ...
  if (!isClient9 || hasClass(document.body, hiddenCls.value)) {
    return;
  }
...
import { isClient as isClient10, useEventListener } from "@vueuse/core";
var modalStack = [];
var closeModal = (e) => {
  ...
  const useModelToggle2 = ({
    ...
    const show = (event) => {
      if (props.disabled === true || isFunction(shouldProceed) && !shouldProceed())
        return;
      const shouldEmit = hasUpdateHandler.value && isClient11;
      if (shouldEmit) {
    ...
    const hide2 = (event) => {
      if (props.disabled === true || !isClient11)
        return;
      const shouldEmit = hasUpdateHandler.value && isClient11;
      if (shouldEmit) {
...
var useId = (deterministicId) => {
  ...
  if (!isClient13 && idInjection === defaultIdInjection) {
...
import { isClient as isClient14 } from "@vueuse/core";
...
import { isClient as isClient15 } from "@vueuse/core";
var cachedContainer;
...
import { isClient as isClient16, unrefElement } from "@vueuse/core";
...
import { useEventListener as useEventListener3 } from "@vueuse/core";
function useFocusController(target2, { afterFocus, afterBlur } = {}) {
  ...
  useEventListener3(wrapperRef, "click", handleClick);
  return {
    wrapperRef,
    isFocused,
    handleFocus,
...
*/
//# sourceMappingURL=chunk-CEHVTSFD.js.map
